<?php
include_once '../class/gradebook.condition.php'; 
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../assets/styles/gradebook.private.css?<?php echo time(); ?>">
</head>
<body>
	<!-- DASHBOARD WRAPPER -->
		...
		<div class="sidebar">
			...
			<?php if($type == '0'){ ?>
				<ul class="nav-links">
					...
					<li><a href="student.php" class="<?php if($urlName == 'student.php'){echo 'active-link';} ?>">Students</a></li>
					<li><a href="faculty.php" class="<?php if($urlName == 'faculty.php'){echo 'active-link';} ?>">Teachers</a></li>
					<li><a href="subject.php" class="<?php if($urlName == 'subject.php'){echo 'active-link';} ?>">Subjects</a></li>
			...
			<?php if($type == '1'){ ?>
				<ul class="nav-links">
					...
					<li><a href="classes.php" class="<?php if($urlName == 'classes.php'){echo 'active-link';} ?>">My Classes</a></li>
					<li><a href="assignment_add.php" class="<?php if($urlName == 'assignment_add.php'){echo 'active-link';} ?>">Upload Assignment</a></li>
					<li><a href="annocement.php" class="<?php if($urlName == 'annocement.php'){echo 'active-link';} ?>">Post Announcement</a></li>
				</ul>
			<?php } ?>
			<?php if($type == '2'){ ?>
				<ul class="nav-links">
