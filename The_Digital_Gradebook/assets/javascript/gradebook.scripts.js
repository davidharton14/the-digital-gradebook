function setCredentials(e){
	...
	xhr.open('POST', '../class/gradebook.condition.php', true);
...
function setRegisterTeacher(e){
	...
	var pass = document.getElementById('password').value;
	var cpass = document.getElementById('confirm-password').value;
	var param = "userid="+userid+"&fname="+fname+"&lname="+lname+"&email="+pass+"&password="+pass+"&confirm-password="+cpass+"&action="+action;
