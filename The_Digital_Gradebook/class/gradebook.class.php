...
class Gradebook{
		...
		try{
			if(!empty($userid) && !empty($password)){
				$stmt = $this->DB->prepare("SELECT USER_ID, `PASSWORD`, '0' AS TYPE FROM tbl_user
											...
											UNION SELECT TEACHER_ID, `PASSWORD`, '1' AS TYPE FROM tbl_teacher
											WHERE TEACHER_ID = :userid AND `PASSWORD` = :password
	...
	public function loggedIn($userid, $type){
		if(isset($userid) && isset($type)){
			if($type == '0'){
				...
				$stmt = $this->DB->prepare("SELECT * FROM tbl_teacher WHERE TEACHER_ID = :userid");
				$stmt->bindValue(':userid', $userid);
				$stmt->execute();
	...
	public function setTeacherInfo($userid, $first_name, $last_name, $password, $date){
		try{
			if(!empty($userid) && !empty($first_name) && !empty($last_name) && !empty($password) && !empty($date)){
				$stmt = $this->DB->prepare("INSERT INTO tbl_teacher(TEACHER_ID, FIRST_NAME, LAST_NAME, PASSWORD, STATUS, DATE) VALUES(:userid, :firstname, :lastname, :password, 'Registered', :date)");
				$stmt->bindValue(':userid', $userid);
	...
	public function setClass($classcode, $subjectid, $facultyid, $syid, $date){
		try{
			if(!empty($classcode) && !empty($subjectid) && !empty($facultyid) && !empty($syid) && !empty($date)){
				$stmt = $this->DB->prepare("INSERT INTO tbl_class(CLASS_CODE, SUBJECT_ID, TEACHER_ID, SCHOOL_YEAR_ID, SEMESTER, DATE) VALUES(:classcode, :subjectid, :facultyid, :syid, 0, :date)");
	...
	public function getClasses(){
		try{
			$stmt = $this->DB->prepare("SELECT * FROM tbl_class AS class INNER JOIN tbl_subject AS subj ON class.SUBJECT_ID = subj.SUBJECT_ID INNER JOIN tbl_teacher AS fac ON class.TEACHER_ID = fac.TEACHER_ID INNER JOIN tbl_school_yr AS sy ON class.SCHOOL_YEAR_ID = sy.ID ORDER BY CLASS_ID DESC");
			$stmt->execute();
			...
			echo "<tr><td>".$code."</td><td>".$subj."</td><td>".$first_name." ".$last_name."</td><td>".$sy."</td><td><a href='classes_students.php?id=" . $id . "'><img src='../assets/img/eye1.png'> View Students</a><a href='classes.php?id=" . $id . "&action=deleteClass' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
	...
	public function getClassesTeacher($userid){
		try{
			$stmt = $this->DB->prepare("SELECT * FROM tbl_class AS class INNER JOIN tbl_subject AS subj ON class.SUBJECT_ID = subj.SUBJECT_ID INNER JOIN tbl_teacher AS fac ON class.TEACHER_ID = fac.TEACHER_ID INNER JOIN tbl_school_yr AS sy ON class.SCHOOL_YEAR_ID = sy.ID WHERE class.TEACHER_ID = :id ORDER BY CLASS_ID DESC");
			...
			echo "<tr><td>".$code."</td><td>".$subj."</td><td>".$first_name." ".$last_name."</td><td>".$sy."</td><td><a href='class.php?cid=" . $id . "'><img src='../assets/img/eye1.png'> Open</a></td></tr>";
			}
	...
	public function getClassesStudent($userid){
		try{
			...
			while($row1 = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				$stmt2 = $this->DB->prepare("SELECT * FROM tbl_class AS class INNER JOIN tbl_subject AS subj ON class.SUBJECT_ID = subj.SUBJECT_ID INNER JOIN tbl_teacher AS fac ON class.TEACHER_ID = fac.TEACHER_ID INNER JOIN tbl_school_yr AS sy ON class.SCHOOL_YEAR_ID = sy.ID WHERE class.CLASS_ID = :cid ORDER BY CLASS_ID DESC");
				...
				while($row = $stmt2->fetch(PDO::FETCH_ASSOC)){
					...
					$last_name = htmlentities($row['LAST_NAME']);
					$sy = htmlentities($row['SCHOOL_YEAR']);
				echo "<tr><td>".$code."</td><td>".$subj."</td><td>".$first_name." ".$last_name."</td><td>".$sy."</td><td><a href='class.php?cid=" . $id . "'><img src='../assets/img/eye1.png'> Open</a>";
				}
			}
	...
	public function getStudentsAd(){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$sid."</td><td>".$first_name."</td><td>".$last_name."</td><td>".$email."</td><td><a href='student_edit.php?id=" . $sid . "&action=select-student'><img src='../assets/img/edit.png'> Edit</a><a href='student.php?id=" . $sid . "&action=deleteStudent' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
	...
	public function getFacultyAd(){
		try{
			$stmt = $this->DB->prepare("SELECT * FROM tbl_teacher");
			$stmt->execute();
			
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				$fid = htmlentities($row['TEACHER_ID']);
				$first_name = htmlentities($row['FIRST_NAME']);
				$last_name = htmlentities($row['LAST_NAME']);
				
				echo "<tr><td>".$fid."</td><td>".$first_name."</td><td>".$last_name."</td><td><a href='faculty_edit.php?id=" . $fid . "&action=select-faculty'><img src='../assets/img/edit.png'> Edit</a><a href='faculty.php?id=" . $fid . "&action=deleteFaculty' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
	...
	public function getSubjectAd(){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$scode."</td><td>".$title."</td><td><a href='subject_edit.php?id=" . $id . "&action=select-subject'><img src='../assets/img/edit.png'> Edit</a><a href='subject.php?id=" . $scode . "&action=deleteSubject' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
	...
	public function getUsersAd(){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$uid."</td><td>".$first_name.' '.$last_name."</td><td><a href='users_edit.php?id=" . $uid . "&action=select-user'><img src='../assets/img/edit.png'> Edit</a><a href='users.php?id=" . $uid . "&action=deleteUser' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
	...
	public function getSYAd(){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$sy."</td><td>".$date."</td><td><a href='school_year.php?id=" . $id . "&action=activateSY' onclick=\"return confirm('Do you want to change the school year?');\"><img src='../assets/img/check1.png'> Activate</a><a href='school_year.php?id=" . $id . "&action=deleteSY' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
	...
	public function getAnnounceAd(){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$title."</td><td> by ".$user."</td><td>".$date."</td><td><a href='announcement_view.php?id=" . $id . "&action=select-announce'><img src='../assets/img/eye1.png'> View</a><a href='announcement_edit.php?id=" . $id . "&action=select-announce'><img src='../assets/img/edit.png'>Edit</a><a href='announcement.php?id=" . $id . "&action=deleteAnnounce' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
	...
	public function getAnnounceStudentAd($id, $cid){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$title."</td><td> by ".$user."</td><td>".$date."</td><td><a href='announcement_view.php?cid=".$cid."&id=" . $id . "&action=select-announce'><img src='../assets/img/eye1.png'> View</a>";
			}
	...
	public function isFacultyId($facultyid){
		$stmt = $this->DB->prepare("SELECT * FROM tbl_teacher WHERE TEACHER_ID = :facultyid");
		$stmt->bindValue(':facultyid', $facultyid);
		$stmt->execute();
		
		$row = $stmt->fetch(PDO::FETCH_ASSOC);
		$id = htmlentities($row['TEACHER_ID']);
	...
	public function getTeachersRegistered(){
		try{
			$stmt = $this->DB->prepare("SELECT COUNT(TEACHER_ID) AS rowCount FROM tbl_teacher WHERE STATUS='Registered'");
			$stmt->execute();
			$row = $stmt->fetch(PDO::FETCH_ASSOC);
			echo $row['rowCount'];
		}catch(Exception $e){
	...
	public function getLatestAnnounce(){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$title."</td><td> by ".$user."</td><td>".$date."</td><td><a href='announcement_view.php?id=" . $id . "&action=select-announce'><img src='../assets/img/eye1.png'> View</a>";
			}
	...
	public function getFacultySelectTeacher($id){
		try{
			$stmt = $this->DB->prepare("SELECT * FROM tbl_teacher WHERE TEACHER_ID = :id");
			$stmt->bindValue(':id', $id);
			$stmt->execute();
	...
	public function getClassSelect($id){
		try{
			$stmt = $this->DB->prepare("SELECT * FROM tbl_class WHERE TEACHER_ID = :id");
			$stmt->bindValue(':id', $id);
			$stmt->execute();
	...
	public function deleteFaculty($id){
		try{
			$stmt = $this->DB->prepare("DELETE FROM tbl_teacher WHERE TEACHER_ID = :id");
			$stmt->bindValue(':id', $id);
			$stmt->execute();
		}catch(Exception $e){
			echo "Something went wrong!";
	...
	public function getQuizes($id){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td><a href='questions.php?cid=" . $id . "&id=".$sid."'>".$quiz."</a></td><td>".$date."</td><td><a href='quiz_edit.php?id=" . $sid . "&action=select-quiz'><img src='../assets/img/edit.png'>Edit</a><a href='quiz.php?cid=".$id."&id=" . $sid . "&action=deleteQuiz' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
	...
	public function getStudentQuizes($id, $user){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$quiz."</td><td>".$date."</td><td><a href='quiz_answer.php?cid=" . $id . "&id=" . $sid . "&action=answer-quiz'><img src='../assets/img/edit.png'> Take Quiz</a></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
	...
	public function viewQuizes($id){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$quiz."</td><td>".$date."</td><td><a href='grade_students.php?id=" . $sid . "&cid=" . $id . "'><img src='../assets/img/eye1.png'> View Scores</a></td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
	...
	public function getQuestions($cid, $id){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$question."</td><td>".$ca."</td><td>".$cb."</td><td>".$cc."</td><td>".$cd."</td><td>".$answer."</td><td><a href='questions_edit.php?id=" . $qid . "&action=select-question'><img src='../assets/img/edit.png'>Edit</a><a href='questions.php?cid=".$cid."&id=" . $id ."&qid=" . $qid . "&action=deleteQuestion' onclick=\"return confirm('Are you sure you want to delete?');\"><img src='../assets/img/trash.png'>Delete</a></td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
	...
	public function getClassFaculty($id){
		try{
			...
			$stmt = $this->DB->prepare("SELECT * FROM tbl_teacher WHERE TEACHER_ID = :fid");
	...
	public function getClassStudents($id){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$sid."</td><td>".$fname." ".$lname."</td><td>".$email."</td></td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
	...
	public function getClassStudentsStud($id){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$sid."</td><td>".$fname." ".$lname."</td><td>".$email."</td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
	...
	public function getClassStudentsTeacher($id){
		try{
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$sid."</td><td>".$fname." ".$lname."</td><td>".$email."</td><td><a href='classes_students.php?id=" . $id . "&sid=".$sid."&action=deleteClassStudent'></a></td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
...
WHERE STUDENT_ID NOT IN (SELECT STUDENT_ID FROM tbl_class_student WHERE CLASS_ID = :id);");
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$sid."</td><td>".$fname." ".$lname."</td><td>".$email."</td><td><a href='classes_students.php?id=" . $id . "&sid=".$sid."&action=addToClass'><img src='../assets/img/pluss.png'>Add Student</a></td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
...
WHERE STUDENT_ID NOT IN (SELECT STUDENT_ID FROM tbl_class_student WHERE CLASS_ID = :id);");
			...
			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				...
				echo "<tr><td>".$sid."</td><td>".$fname." ".$lname."</td><td>".$email."</td><td><a href='students.php?id=" . $id . "&sid=".$sid."&action=addToClass'><img src='../assets/img/pluss.png'>Add Student</a></td></tr>";
			}
		}catch(Exception $e){
			echo "Something went wrong!";
		}
	...
	public function setStudent($userid, $first_name, $last_name, $email, $password, $date){
		try{
			$stmt = $this->DB->prepare("INSERT INTO tbl_student(STUDENT_ID, FIRST_NAME, LAST_NAME, EMAIL, `PASSWORD`, STATUS, `DATE`) VALUES(:userid, :firstname, :lastname, :email, :password, 'Registered', :date)");
			$stmt->bindValue(':userid', $userid);
			$stmt->bindValue(':firstname', $first_name);
			$stmt->bindValue(':lastname', $last_name);
	...
	public function editStudent($userid, $first_name, $last_name, $email, $password, $date){
		try{
			$stmt = $this->DB->prepare("UPDATE tbl_student SET STUDENT_ID = :userid, FIRST_NAME = :firstname, LAST_NAME = :lastname, EMAIL = :email, PASSWORD = :password, `DATE` = :date WHERE STUDENT_ID = :userid");
			$stmt->bindValue(':userid', $userid);
			$stmt->bindValue(':firstname', $first_name);
			$stmt->bindValue(':lastname', $last_name);
			$stmt->bindValue(':email', $email);
	...
	public function editTeacherInfo($userid, $first_name, $last_name, $password, $date){
		try{
			if(!empty($userid) && !empty($first_name) && !empty($last_name) && !empty($password) && !empty($date)){
				$stmt = $this->DB->prepare("UPDATE tbl_teacher SET TEACHER_ID = :userid, FIRST_NAME = :firstname, LAST_NAME = :lastname, PASSWORD = :password, `DATE` = :date WHERE TEACHER_ID = :userid");
				$stmt->bindValue(':userid', $userid);
				$stmt->bindValue(':firstname', $first_name);
				$stmt->bindValue(':lastname', $last_name);
				$stmt->bindValue(':password', $password);
	...
	public function getStudentID($id){
		try{
			...
			return array($id, $fname, $lname, $email, $password);
		}catch(Exception $e){
			echo "Something went wrong ! \n" . $e->getMessage();
		}
	}
