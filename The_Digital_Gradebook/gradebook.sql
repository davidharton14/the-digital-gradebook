...
(429, 'fac-00123', 'created a new question ', '2021-05-28 03:44 PM'),
(428, 'fac-00123', 'created a new question ', '2021-05-28 03:43 PM'),
(427, 'fac-00123', 'created a new quiz ', '2021-05-28 03:42 PM'),
(426, 'admin', 'added student to class XII A', '2021-05-28 03:30 PM'),
(425, 'admin', 'XII A', '2021-05-28 03:29 PM'),
(424, 'admin', 'created new subject Matematica', '2021-05-28 03:29 PM'),
(423, 'admin', 'created new subject Limba si literatura romana', '2021-05-28 03:28 PM'),
(422, 'admin', 'created new subject Logica', '2021-05-28 03:27 PM'),
(421, 'admin', 'added new faculty Ducuta Ioana', '2021-05-28 03:09 PM'),
(420, 'admin', 'added new student Popescu Alexandru', '2021-05-28 03:08 PM'),
(419, 'admin', 'activate school year 6 ', '2021-05-28 03:04 PM'),
(418, 'admin', 'created a new school year 2021-2022', '2021-05-28 03:04 PM');
...
INSERT INTO `tbl_class` (`CLASS_ID`, `CLASS_CODE`, `SUBJECT_ID`, `TEACHER_ID`, `SCHOOL_YEAR_ID`, `SEMESTER`, `DATE`) VALUES
(25, 'XII A', 9, 'fac-00123', '6', '0', '2019-05-28 03:29 PM');
...
INSERT INTO `tbl_teacher` (`TEACHER_ID`, `FIRST_NAME`, `LAST_NAME`, `PASSWORD`, `IMAGE`, `STATUS`, `DATE`) VALUES
('fac-00123', 'Ducuta', 'Ioana', 'pass123', NULL, 'Registered', '2021-05-28 03:09 PM');
...
(3, 2, '1 plus 1', '3', '1', '9', '2', 'D', '2021-01-26 06:04 AM'),
(4, 2, 'What is my name', 'Tom', 'Mat', 'Ken', 'Krizo', 'B', '2021-01-26 10:02 PM'),
(5, 3, '1 plus 1', 'asd', 'asd', 'asd', 'asdad', 'A', '2021-05-04 11:51 PM'),
(6, 1, 'What is CPU', 'Apple', 'Pen', 'Pineapple', 'Parts of the computer', 'D', '2021-05-28 03:43 PM'),
(7, 1, 'What is keyboard', 'Pineaple', 'Colors', 'Flowers', 'Parts of the computer', 'D', '2021-05-28 03:44 PM');
...
(1, 'Parts of the Computer', 25, 0, '2021-05-28 03:42 PM');
...
(1, '2021-2022', 'INACTIVE', ''),
(6, '2022-2023', 'ACTIVE', '2021-05-28 03:04 PM');
...
INSERT INTO `tbl_student` (`STUDENT_ID`, `FIRST_NAME`, `LAST_NAME`, `EMAIL`, `PASSWORD`, `IMAGE`, `STATUS`, `DATE`) VALUES
('00522', 'Popa', 'Maria', 'BSIT', 'pass123', NULL, 'Registered', '2021-05-28 03:08 PM');
...
(10, 'ITE2', 'Matematica', '2021-05-28 03:28 PM'),
(9, 'ITE1', 'Limba si literatura romana', '2021-05-28 03:27 PM'),
(11, 'ITE4', 'Logica', '2021-05-28 03:29 PM');
...
('admin', 'admin', '', 'admin', '2021-05-17 08:03 PM');
...
(288, '00522', '2021-05-28 03:52 PM'),
(287, 'fac-00123', '2021-05-28 03:31 PM'),
(286, 'admin', '2021-05-28 03:03 PM'),
(285, 'admin', '2021-05-23 12:11 PM'),
(284, 'admin', '2021-05-21 03:31 PM'),
(283, 'admin', '2021-05-21 03:31 PM');
